...
1. Write programs using core features of the Java language, including variables, conditionals, methods, and loops.

2. Use common built-in Java classes.

3. Develop programs with another person.
...
We will also use Mimir as an online development and automatic grading platform. It costs about $25 for one class. I'll send out the
details of how to connect your Mimir account to the class by e-mail.
...
1. A set of autograded programming assignments. Each assigned problem will have one or more tests, which the Mimir system can automatically check against your code. Passing the test gives you credit for completing that problem. You can attempt each problem as many times as you want and the problems will remain open from the time they are posted until the day of the final exam, so you have the opportunity to revisit and complete problems that may have been too challenging when they were first assigned.
2. Three major projects, one before the midterm, one in the middle of the second half, and one at the end of the course.
3. A written midterm exam.
...
For the autograded problems, passing the test will indicate that your code is satisfactory.

### Final Letter Grades

**To earn a B**, you must meet the following five criteria:

1. Pass the tests for at least 90% of all autograded programming problems assigned during the semester.
...
5. No more than two absences from lab.
...
|------------------------------------------------|------------------------------------------|
| Completing less than 90% of autograded tests | Half a letter grade (e.g. B to B-)       |
| Completing less than 80%, 70%, etc. of autograded tests | Half a letter grade for each 10%       |
| One major project                           | Half a letter grade                      |
| Additional major projects                   | A full letter grade                      |
| The midterm exam                                | Half a letter grade                     |
| The final exam                                 | A full letter grade                      |
| Missing more than two lab sessions | Half a letter grade                      |
| Missing more than four lab sessions | A full letter grade  |
...
If your grade drops, you can still complete extra work to boost it up. For example, you could struggle with one project deliverable, but
